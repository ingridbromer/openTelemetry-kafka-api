...
public class SecurityConfig extends WebSecurityConfigurerAdapter {
	...
	// Enumerador com endpoints para whitelist de autenticação
	...
	// Função boiler plate para configurar segurançã de HTTP
	@Override
	...
	// Função boiler plate necessária para funcionamento do sistema de segurança
	@Bean
